...
```{r}
ggplot(data = county_df) + geom_histogram(aes(x = county_df$Income))
ggplot(county_df, aes(county_df$Income)) + geom_density()
ggplot(county_df) + geom_violin(aes(x=county_df$Income, stat = "ydensity"))
```
...
```{r histo_totpop}
ggplot(data = county_df) + geom_bar(mapping = aes(x=county_df$TotalPop))
```
